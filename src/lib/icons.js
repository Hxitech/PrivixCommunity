...
const PATHS = {
  ...
  // 龙虾钳子（胖胖圆润版）
  'lobster-claw': '<ellipse cx="6" cy="6.5" rx="4.5" ry="5" fill="currentColor" opacity="0.1"/><ellipse cx="18" cy="6.5" rx="4.5" ry="5" fill="currentColor" opacity="0.1"/><path d="M3 3.5C1.5 5 1.5 8 3 9.5c1 1 2.5 1.2 4 .5"/><path d="M9 3.5c1.5 1.5 1.5 4.5 0 6-1 1-2.5 1.2-4 .5"/><path d="M21 3.5c1.5 1.5 1.5 4.5 0 6-1 1-2.5 1.2-4 .5"/><path d="M15 3.5c-1.5 1.5-1.5 4.5 0 6 1 1 2.5 1.2 4 .5"/><path d="M9 10.5Q10.5 13 12 13.5Q13.5 13 15 10.5"/><path d="M12 13.5v7" stroke-width="2.5"/><circle cx="12" cy="21.5" r="1.2" fill="currentColor"/>',
  ...
  // Phase H · v1.4.4 新增 — 替代 emoji 的严肃化 SVG
  'activity': '<polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>',
  'flask': '<path d="M9 3h6M10 3v7.5L4 20a2 2 0 001.7 3h12.6a2 2 0 001.7-3l-6-9.5V3"/><line x1="6.5" y1="16" x2="17.5" y2="16"/>',
  'bank': '<path d="M3 9l9-6 9 6"/><rect x="3" y="9" width="18" height="2"/><line x1="6" y1="11" x2="6" y2="18"/><line x1="10" y1="11" x2="10" y2="18"/><line x1="14" y1="11" x2="14" y2="18"/><line x1="18" y1="11" x2="18" y2="18"/><rect x="2" y="18" width="20" height="3"/>',
  'book-open': '<path d="M2 3h6a4 4 0 014 4v14a3 3 0 00-3-3H2z"/><path d="M22 3h-6a4 4 0 00-4 4v14a3 3 0 013-3h7z"/>',
  'telescope': '<path d="M3 17l5-5M13 7l4-4 3 3-4 4M7 11l6 6"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor"/><line x1="10" y1="20" x2="14" y2="20"/><line x1="12" y1="17" x2="12" y2="22"/>',
  'wallet': '<path d="M21 12V7H5a2 2 0 010-4h14v4"/><path d="M3 5v14a2 2 0 002 2h16v-5"/><path d="M18 12a2 2 0 000 4h4v-4z"/>',
  'scales': '<path d="M12 3v18"/><line x1="5" y1="21" x2="19" y2="21"/><path d="M6 8l-4 6a4 4 0 008 0L6 8z"/><path d="M18 8l-4 6a4 4 0 008 0L18 8z"/><line x1="6" y1="8" x2="18" y2="8"/>',
  'brain': '<path d="M9.5 2A2.5 2.5 0 017 4.5v0A2.5 2.5 0 014.5 7v0A2.5 2.5 0 002 9.5v1A2.5 2.5 0 004.5 13v0A2.5 2.5 0 007 15.5v0A2.5 2.5 0 019.5 18v2a2 2 0 002 2h0a2 2 0 002-2v-2a2.5 2.5 0 012.5-2.5v0A2.5 2.5 0 0019.5 13v0A2.5 2.5 0 0022 10.5v-1A2.5 2.5 0 0019.5 7v0A2.5 2.5 0 0117 4.5v0A2.5 2.5 0 0014.5 2h-5z"/>',
